...
const SHELL_CACHE="gewu-shell-v97";   // ← 每次部署 bump 這行(觸發新 SW + 自動重整)
...
const SHELL=["./","index.html","engine.js","manifest.json","data/game.json","design.html","assets/fonts/notosanstc.woff2","assets/img/title_keyart_v16.webp","assets/img/title_lockup_v1.webp","assets/seal.svg","assets/icons/icon-192.png","assets/icons/icon-512.png","assets/icons/apple-touch-icon.png","assets/icons/maskable-512.png"];
